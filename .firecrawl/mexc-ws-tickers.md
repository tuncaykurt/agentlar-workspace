[Skip to main content](https://www.mexc.com/api-docs/futures/websocket-api/tickers#__docusaurus_skipToContent_fallback "Skip to main content")
...
[English](https://www.mexc.com/api-docs/futures/websocket-api/tickers# "English")

- [English](https://www.mexc.com/api-docs/futures/websocket-api/tickers "English")
- [中文](https://www.mexc.com/zh-MY/api-docs/futures/websocket-api/tickers "中文")
...
- [WebSocket API](https://www.mexc.com/api-docs/futures/websocket-api/ "WebSocket API")
  ...
  - [Public channels](https://www.mexc.com/api-docs/futures/websocket-api/tickers# "Public channels")
  ...
  - [Private channels](https://www.mexc.com/api-docs/futures/websocket-api/tickers# "Private channels")
...
[Previous\\
\\
Subscription filtering](https://www.mexc.com/api-docs/futures/websocket-api/subscription-filtering "PreviousSubscription filtering") [Next\\
\\
Get a single ticker](https://www.mexc.com/api-docs/futures/websocket-api/get-a-single-ticker "NextGet a single ticker")