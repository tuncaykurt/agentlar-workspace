...
// turbo
```bash
cd ANTIGRAVITY_ROOT_BURAYA/_skills/marketing/fatura-olusturucu
...
// turbo
```bash
open -R "ANTIGRAVITY_ROOT_BURAYA/_skills/marketing/fatura-olusturucu/uretilen-faturalar/INVOICE_${SAFE_BRAND}_${DATE}.pdf"
```

3. Ayrıca kullanıcıya dosyanın tıklanabilir linkini ver: `[INVOICE_Marka_GG-AA-YYYY.pdf](file://ANTIGRAVITY_ROOT_BURAYA/_skills/marketing/fatura-olusturucu/uretilen-faturalar/INVOICE_Marka_GG-AA-YYYY.pdf)`
