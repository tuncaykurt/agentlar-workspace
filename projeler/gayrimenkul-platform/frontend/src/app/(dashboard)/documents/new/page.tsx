...
const DOC_TYPES: { value: DocumentType; label: string; desc: string; color: string }[] = [
  ...
  { value: 'showing_agreement', label: 'Yer Gösterme Belgesi', desc: 'Mülk gösterim tutanağı',      color: 'indigo' },
]
...
function generatePrintHTML(params: {
  ...
  const { docType, mainClient, secondClient, property, consultant, templateData, officeName, officeLegalName, officeAddress, officeMersis, officeJurisdiction, officeLogo } = params
    ...
    authorization: {
      ...
      body: `
        ...
        <div style="margin-top:8px;">
          ...
          <p class="clause"><strong>7. İHTIILAF:</strong> Bu sözleşmenin uygulanmasından doğacak her türlü uyuşmazlıkta ${officeJurisdiction || '_______________'} Mahkemeleri ve İcra Daireleri yetkilidir. Doğacak damga vergisi, resim, pul ve harçların tamamı müşteriye aittir.</p>
    ...
    sales_contract: {
      ...
      body: `
        ...
        <div style="line-height:1.9;font-size:15px;">
          ...
          <p style="margin-bottom:12px;text-align:justify;">
            <strong>4-</strong> ALICI ve SATICI'nın her biri, daha sonra alım ve/veya satımdan vazgeçerlerse veya ${officeName}'in dışında gelişen herhangi bir nedenle tapudaki satışı gerçekleştiremezseler; vazgeçen ve/veya satışa engel çıkartan taraf hem kendi ödeyeceği, hem de diğer tarafın ödeyeceği komisyon ücretinin tamamını <strong>(% ${(parseFloat(String(templateData.komisyon_alici||2))+parseFloat(String(templateData.komisyon_satici||2))).toFixed(0)} + KDV)</strong> ${officeName}'a ödemeyi peşinen kabul ve taahhüt eder.
          </p>
          <p style="margin-bottom:12px;text-align:justify;">
      ...
      body: `
        ...
        <div style="display:flex;justify-content:space-around;margin:28px 0 20px;font-size:11px;font-weight:bold;text-align:center;">
          ...
          <ol style="font-size:11px;line-height:1.8;padding-left:20px;">
            ...
            <li>İş bu kira sözleşmesinden doğacak ihtilaflarda ${officeJurisdiction || '_______________'} Mahkemeleri ve İcra Daireleri yetkilidir.</li>
