...
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py analyze Projeler/Yeni_Proje

# Gerekli tokenları bağla (filtrelenmiş .env oluştur)
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py generate Projeler/Yeni_Proje --services openai,telegram,kie

# VEYA symlink ile tüm tokenlara erişim ver
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py link Projeler/Yeni_Proje
```
...
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py update OPENAI_API_KEY "yeni-token-değeri"

# Symlink kullanan projeler otomatik güncellenir
# Filtrelenmiş .env kullanan projeleri yenile
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py refresh-all
```
...
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py scan
```
...
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py generate Projeler/XYZ --services google_service_account
```
...
```bash
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py generate Projeler/XYZ --services openai,telegram
```
...
### Adım 3: Doğrulama
```bash
python3 _skills/dev/sifre-yonetici/scripts/env_manager.py verify Projeler/XYZ
```
