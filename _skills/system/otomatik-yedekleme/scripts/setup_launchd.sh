...
PLIST_SOURCE="$HOME/Desktop/Antigravity/_skills/system/otomatik-yedekleme/scripts/com.antigravity.backup.plist"
PLIST_TARGET="$HOME/Library/LaunchAgents/com.antigravity.backup.plist"
BACKUP_SCRIPT="$HOME/Desktop/Antigravity/_skills/system/otomatik-yedekleme/scripts/backup.sh"
