...
```
_skills/system/otomatik-yedekleme/
├── SKILL.md              # Bu dosya
├── scripts/
...
```bash
bash ~/Desktop/Antigravity/_skills/system/otomatik-yedekleme/scripts/setup_cron.sh
```

Bu komut crontab'a şu satırı ekler:
```
0 3 * * 0 /bin/bash ~/Desktop/Antigravity/_skills/system/otomatik-yedekleme/scripts/backup.sh
```
